...
const sections: MenuSection[] = [
  ...
  { label: '设备与安灯', items: [
    ...
    { id: 'equip-ledger', label: '设备详情', to: '/equipment/detail', icon: 'gear' },
    { id: 'andon', label: '安灯异常', to: '/andon/exceptions', badge: '3', icon: 'warn' },
  ]},
  { label: '条码与追溯', items: [
    { id: 'barcode', label: '条码管理', to: '/barcode/list', icon: 'scan' },
    { id: 'barcode-rules', label: '条码类型', to: '/barcode/types', icon: 'boxes' },
  ...
  { label: '电子 SOP', items: [
    ...
    { id: 'sop-docs', label: '版本管理', to: '/sop/versions', icon: 'list' },
    { id: 'sop-tasks', label: '任务下发', to: '/sop/tasks', icon: 'arrow' },
    { id: 'sopexec', label: '执行终端', to: '/sop/execution', icon: 'check' },
    { id: 'sop-docs', label: '步骤编排', to: '/sop/steps', icon: 'boxes' },
    { id: 'sop-docs', label: '绑定配置', to: '/sop/bindings', icon: 'gear' },
  ]},
  { label: '控制中心', items: [
